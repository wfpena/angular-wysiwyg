...
# AngularEditor
[![npm version](https://badge.fury.io/js/%40wfpena%2Fangular-editor.svg)](https://badge.fury.io/js/%40wfpena%2Fangular-editor)
[![demo](https://img.shields.io/badge/demo-StackBlitz-blueviolet.svg)](https://stackblitz.com/edit/angular-editor-wysiwyg)
[![Build Status](https://travis-ci.com/wfpena/angular-editor.svg?branch=master)](https://travis-ci.com/wfpena/angular-editor)
[![npm](https://img.shields.io/npm/dm/@wfpena/angular-editor.svg)](https://www.npmjs.com/package/@wfpena/angular-editor)
[![](https://data.jsdelivr.com/v1/package/npm/@wfpena/angular-editor/badge?style=rounded)](https://www.jsdelivr.com/package/npm/@wfpena/angular-editor)
[![Coverage Status](https://coveralls.io/repos/github/wfpena/angular-editor/badge.svg?branch=master)](https://coveralls.io/github/wfpena/angular-editor?branch=master)
[![codecov](https://codecov.io/gh/wfpena/angular-editor/branch/master/graph/badge.svg)](https://codecov.io/gh/wfpena/angular-editor)
[![Donate](https://img.shields.io/badge/Donate-PayPal-green.svg)](https://paypal.me/wfpena)
...
```bash
npm install @wfpena/angular-editor --save
```
### Versions
...
import { AngularEditorModule } from '@wfpena/angular-editor';
...
```js
import { AngularEditorConfig } from '@wfpena/angular-editor';
...
{
  "glob": "**/*",
  "input": "./node_modules/@wfpena/angular-editor/assets/",
  "output": "./assets/fonts/"
}
```
...
The documentation for the AngularEditor is hosted at our website [AngularEditor](https://angular-editor.wfpena.ru/)

## Contributing

Please read through our [contributing guidelines](https://github.com/wfpena/angular-editor/blob/master/CONTRIBUTING.md). Included are directions for opening issues, coding standards, and notes on development.

Editor preferences are available in the [editor config](https://github.com/wfpena/angular-editor/blob/master/.editorconfig) for easy use in common text editors. Read more and download plugins at <http://editorconfig.org>.
...
See [the Releases section of our project](https://github.com/wfpena/angular-editor/releases) for changelogs for each release version.

## Creators

**Wilson Pena**

* <https://github.com/wfpena>

## Donate

If you like my work and I save your time you can buy me a :beer: or :pizza: [![Donate](https://img.shields.io/badge/Donate-PayPal-green.svg)](https://paypal.me/wfpena)
